...
return [
    ...
    */
    ...
    "DOMPDF_ENABLE_REMOTE" => true, // Permet le chargement d'images externes
    "DOMPDF_TEMP_DIR" => storage_path('temp'), // Dossier temporaire
    "default_font" => "dejavu sans", // Police par défaut (prend en charge UTF-8)
